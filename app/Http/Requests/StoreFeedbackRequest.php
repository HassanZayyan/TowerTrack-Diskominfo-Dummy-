...
class StoreFeedbackRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'kategori' => 'required|string|in:suggestion,improvement,complaint,other',
    ...
    public function messages(): array
    {
        return [
            ...
            'kategori.in' => 'Kategori yang dipilih tidak valid. Pilih: suggestion, improvement, complaint, atau other.',
    ...
    public function attributes(): array
    {
        return [
            ...
            'kategori' => 'kategori masukan',
            'lokasi_tower' => 'lokasi tower',
            'tower_id' => 'tower',
            'pesan' => 'pesan masukan',
            'email' => 'alamat email',
            'is_public' => 'visibilitas masukan',
            'reporter_latitude' => 'latitude pengirim',
            'reporter_longitude' => 'longitude pengirim',
