...
export default function ShowFeedback({ feedback, statuses = [], comments, commentCount }: ShowFeedbackProps) {
  ...
  return (
    <MainLayout title={`Detail Masukan #${feedback.id}`} currentPage="/my-messages" headerSlot={headerContent}>
          ...
          <div className="bg-card rounded-lg p-6 border border-border shadow-sm">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between mb-4 border-b border-border pb-4">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Bagikan tanggapan atau pertanyaan terkait masukan ini.</p>
              </div>
              <MessageActionDialog
