            ...
            <div className="text-center">
                ...
                <div className="mt-8">
                    <Link
                        ...
                        className="inline-flex items-center px-6 py-3 bg-red-800 border border-transparent rounded-lg font-semibold text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-800 transition-colors"
                    >
