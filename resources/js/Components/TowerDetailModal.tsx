            ...
            <div className="p-3 sm:p-4 border-t flex flex-col gap-2 flex-shrink-0 bg-white">
              ...
              <div className="flex flex-col sm:flex-row sm:justify-between gap-2 sm:gap-3">
                <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 w-full sm:w-auto">
                  <button 
                    onClick={() => {
                      // Tutup modal dulu untuk trigger cleanup useEffect
                      onClose();
                      // Delay untuk memastikan cleanup useEffect selesai (restore body position)
                      // sebelum memanggil onViewMap yang akan melakukan scrollIntoView
                      setTimeout(() => {
                        onViewMap(tower);
                      }, 150);
                    }} 
