    ...
    <div className="bg-white rounded-xl p-5 border border-gray-200 shadow-sm">
      {heading !== null && (
        <div className="flex items-center gap-2 mb-4">
          <div className={`p-2 bg-gradient-to-br ${accentColorClass} rounded-lg shadow-sm`}>
            <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
            </svg>
          </div>
          {heading && <h5 className="text-sm font-bold text-gray-900">{heading}</h5>}
        </div>
      )}

      <div className="relative space-y-4">
        <div className="absolute left-4 top-6 bottom-6 w-0.5 bg-gradient-to-b from-gray-200 via-gray-300 to-gray-200"></div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        <div className="text-sm font-semibold text-gray-900">{renderDisplayName(response)}</div>
                        {renderSenderBadge(response)}
                      </div>
                      <div className="text-xs text-gray-500">{formatDateTime(response.created_at)}</div>
                    </div>
                  </div>
            ...
            return (
              ...
              >
                <div className="flex items-start justify-between gap-2 mb-3">
                  <div className="flex items-start gap-3">
                    <div className={`flex items-center justify-center w-8 h-8 rounded-full bg-gradient-to-br ${accentColorClass} shadow`}>
                      <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                      </svg>
                    </div>
